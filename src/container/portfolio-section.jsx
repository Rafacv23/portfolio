    ...
    <section className="section" id={props.id}>
            ...
            <Box className="row">
                {projects.map((project) => (
                    <Card id={project.id} className={`project-card ${project.type === 'idle' ? 'project-card-idle' : project.type === 'pomodoro' ? 'project-card-pomodoro' : project.type === 'timer' ? 'project-card-timer' : ''}`}>
                        <div className={`${project.type === 'idle' ? 'project-card-content-idle' : project.type === 'pomodoro' ? 'project-card-content' : project.type === 'timer' ? 'project-card-content-timer' : ''}`}>
                            ...
                            <div className='row'>
                                {project.languages.map((language) => (
                                    <Text className={`language ${language.toLowerCase() === 'react' ? 'react' : 'css'}`} text={language}></Text>
                                ))}
                            </div>
                            <div className='row'>
